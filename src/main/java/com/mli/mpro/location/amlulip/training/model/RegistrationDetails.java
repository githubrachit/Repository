...
public class RegistrationDetails {
	...
	private String strreplytoquest;
	...
	public String getStrreplytoquest() {
		return strreplytoquest;
	}

	public void setStrreplytoquest(String strreplytoquest) {
		this.strreplytoquest = strreplytoquest;
	}
	...
	public String toString() {
		...
		return "RegistrationDetails [agentName=" + agentName + ", registrationNo=" + registrationNo
				+ ", registrationDate=" + registrationDate + ", expiryDate=" + expiryDate + ", agentJoinDate="
				+ agentJoinDate + ", agentPanNo=" + agentPanNo + ", agentAadhaarNo=" + agentAadhaarNo
				+ ", agentContactNo=" + agentContactNo + ", agentEmailId=" + agentEmailId + ", agentDOB=" + agentDOB
				+ ", agentID=" + agentID + ", agentCode=" + agentCode + ", createdDate=" + createdDate
				+ ", strreplytoquest=" + strreplytoquest + ", updatedDate=" + updatedDate + "]";
	}
}
