...
@Component("eInsuranceAccountFormDocument")
@EnableAsync
public class EInsuranceAccountFormDocument implements DocumentGenerationservice {

    private static final Logger logger = LoggerFactory.getLogger(EInsuranceAccountFormDocument.class);
    ...
    public void generateDocument(ProposalDetails proposalDetails) {
        logger.info("Starting EIA document creation.");
        ...
        try {
            ...
            if (isNeoOrAggregator) {
				...
				finalProcessedHtml = springTemplateEngine.process("eia\\main", eiaDetailsContext);
			}
            ...
            if (encodedString.equalsIgnoreCase(AppConstants.FAILED)) {
                ...
                if(proposalDetails.getSourcingDetails()!=null)
                	agentID=proposalDetails.getSourcingDetails().getAgentId();
