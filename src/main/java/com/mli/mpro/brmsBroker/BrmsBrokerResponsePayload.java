...
public class BrmsBrokerResponsePayload {
    ...
    private String jvLineApplicable;
    ...
    @JsonProperty("singlePremiumApplicable")
    private String singlePremiumApplicable;
    ...
    @JsonProperty("jvBranding")
    public String getJvLineApplicable() {
        return jvLineApplicable;
    }

    @JsonProperty("jvBranding")
    public void setJvLineApplicable(String jvLineApplicable) {
        this.jvLineApplicable = jvLineApplicable;
    }
    ...
    public String getSinglePremiumApplicable() {
        return singlePremiumApplicable;
    }

    public void setSinglePremiumApplicable(String singlePremiumApplicable) {
        this.singlePremiumApplicable = singlePremiumApplicable;
    }
    ...
    public String toString() {
        ...
        return "BrmsBrokerResponsePayload{" +
                ...
                ", jvLineApplicable='" + jvLineApplicable + '\'' +
                ...
                ", singlePremiumApplicable='" + singlePremiumApplicable + '\''+
                '}';
    }
}
